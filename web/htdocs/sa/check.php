...
// $Id: check.php 113 2012-11-20 11:42:29Z slavik $
echo "<HTML><HEAD>
...
if (!function_exists("mysql_connect")) { echo "no mysql detected in php. please fix this, otherwise sacc system is unusable<br>";};
if (!function_exists("ldap_connect")) { echo "please add support for ldap into php. otherwise sacc system unable to use AD search <br>";};
if (!function_exists("xml_parser_set_option")) { echo "please add support for xml into php. please fix this, otherwise sacc system unable to perform backup/restore<br>";};
